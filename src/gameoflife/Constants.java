...
public class Constants
{
    ...
    public static final String GET_ROW_MOVE = "Player %s: Enter the row for your next move";
    public static final String GET_COL_MOVE = "Player %s: Enter the column for your next move";
    ...
    public static final String PRINT_MOVE = "Player %s move to %d %d";    
